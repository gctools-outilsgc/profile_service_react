...
// To have this structure working with relative paths, we have to use
// custom options.
...
module.exports = {
    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          ...
          {
            test: /\.css$/,
            loader: ExtractTextPlugin.extract( // eslint-disable-line
              Object.assign(
                {
                  fallback: {
          ...
          // that fall through the other loaders.
          {
            ...
            // "file" loader.  Also exclude `html` and `json` extensions so
            // they get processed by webpacks internal loaders.
  ...
  plugins: [
    ...
    new webpack.optimize.UglifyJsPlugin({
      ...
      output: {
        comments: false,
        // Turned on because emoji and regex is not minified properly  default
    ...
    // practical solution that requires the user to opt into importing specific
    // locales.
